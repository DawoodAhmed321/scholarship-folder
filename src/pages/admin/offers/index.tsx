...
function Offers() {
  ...
  const offers = useSelector((state: TState) => state.offers.offers);
  const pagination = useSelector((state: TState) => state.offers.pagination);
                ...
                <tr key={offer.id}>
                  ...
                  <td>
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <p className="text-sm text-black/50">{offer.title}</p>
                    </div>
                  </td>
                  ...
                  <td>
                    <div className="flex items-center gap-2">
                      <FaEdit
                        ...
                        onClick={() => {
                          dispatch(
                            openModal({ view: "EDIT_OFFER", data: offer })
                          );
                        }}
                      />
                      <MdOutlineDelete
